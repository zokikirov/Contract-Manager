	...
	public class ContractManagerController : Controller
	{
		...
		public ActionResult Delete(string Id)
		{
			...
			try
			{
				...
				List<User> users = userService.GetByUserID(Id);

				auditService.DeleteAuditsByUserId(Id);

				foreach (User user in users)
				{
					contractService.RemoveAllForManagerAndSubUSers(Id, user.Id);
					contractService.DeleteContractsByUserId(user.Id);
					contractTypeService.DeleteByUserId(user.Id);
					auditService.DeleteAuditsByUserId(user.Id);
